...
in the sky. You gently land in a fluffy pile of leaves. It's quite cold, but you don't see much snow. An Elf runs over to greet you.
...
Each game is listed with its ID number (like the in ) followed by a semicolon-separated 
list of subsets of cubes that were revealed from the bag (like ).11Game 11: ...3 red, 5 green, 4 blue
...
# Guardar los colores y los números

# Hacer comprabación de si es posible

# sumar los que son posibles